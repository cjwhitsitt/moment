...
- [x] T114 [US5] Modify SliverGrid delegate to use SliverGridDelegateWithMaxCrossAxisExtent with maxCrossAxisExtent: 270 in clients/mobile/lib/ui/operator_dashboard_page.dart
